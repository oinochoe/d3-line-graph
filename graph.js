...
if (lasttext !== "" && lasttext !== /[0-9]/g) {
  if (lasttext === "k") {
    document.querySelector('.unit').innerText = "(단위 : 1,000)";
  } else if (lasttext === "M") {
    document.querySelector('.unit').innerText = "(단위 : 1,000,000)";
  } else if (lasttext === "G") {
    document.querySelector('.unit').innerText = "(단위 : 1,000,000,000)";
  } else if (lasttext === "T") {
    document.querySelector('.unit').innerText = "(단위 : 1,000,000,000,000)";
  }
}
